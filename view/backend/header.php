<div class="main-header">
    ...
    <div class="logo-header" data-background-color="blue">
      ...
      <a href="index.html" class="logo">
        <img src="public/backend/assets/img/logo/logo.png" alt="Logo site" class="navbar-brand">
      </a>
                  ...
                  <div class="row m-0">
                    <a class="col-6 col-md-4 p-0" href="#">
                      <div class="quick-actions-item">
                        ...
                        <span class="text">Créer une propriété</span>
                      </div>
                    </a>
                    <a class="col-6 col-md-4 p-0" href="#">
                      <div class="quick-actions-item">
                        <i class="flaticon-pen"></i>
                        <span class="text">Créer un profile</span>
                      </div>
                    </a>
                  </div>
                </div>
